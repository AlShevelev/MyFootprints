...
/** From CloseDialogShowed on No button pressed  transition */
class CloseDialogShowedOnNoTransition(
    ...
    model : IPhotoEditorModel) : NotEmptyTransition(stateMachine, model)
{
    ...
    {
        stateMachine.moveToState(transitionsStack.findPrior(States.CloseDialogShowed)!!, false)
    }
}